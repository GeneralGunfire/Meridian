...
export const DATASETS: DatasetSpec[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      col("Metric", "Metric", "Taxpayer_Count / Taxable_Income_ZAR_Millions / Tax_Assessed_ZAR_Millions"),
      col("Value", "Value", "count or ZAR millions"),
      col("Unit", "Unit", "count / ZAR_millions"),
    ],
    color: "bg-emerald-50 border-emerald-100",
    badgeColor: "bg-emerald-100 text-emerald-700",
  },
  ...
  },
  {
    ...
    columns: [
      ...
      col("Department", "Department / Vote", "text, e.g. Vote_27_Health"),
  ...
  },
  {
    ...
    columns: [
      ...
      col("Actual_ZAR", "Actual spend", "ZAR"),
    ],
    color: "bg-teal-50 border-teal-100",
    badgeColor: "bg-teal-100 text-teal-700",
  },
  ...
  },
  {
    ...
    columns: [
      ...
      col("Topic", "Topic", "Water_Source / Sanitation / Electricity_Access / Energy_Cooking / Refuse_Removal — from GHS sheets 25, 30, 31, 34, 36"),
      col("Geography", "Geography", "e.g. South Africa / Eastern Cape"),
      col("Province", "Province", "South Africa / Eastern Cape / etc"),
      col("Category", "Category", "e.g. Piped water / Flush toilet / Electricity"),
      col("Value", "Value", "% or thousands or count"),
  ...
  },
  {
    ...
    columns: [
      col("Year", "Year", "e.g. 2024"),
      col("Topic", "Topic", "Dwelling_Type / Tenure_Status / Household_Income / Medical_Aid / Food_Security — GHS sheets 23, 24, 43, 19, 44"),
      col("Geography", "Geography", "e.g. South Africa / KwaZulu-Natal"),
      col("Province", "Province", "South Africa / Eastern Cape / etc"),
      col("Category", "Category", "e.g. Formal dwelling / Owned / R0-R800 income bracket"),
      col("Value", "Value", "% or thousands or count"),
      col("Unit", "Unit", "% / thousands / count"),
    ],
